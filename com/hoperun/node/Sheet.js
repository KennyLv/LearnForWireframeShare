 ...
 * @import com.hoperun.util.BaseTool,com.hoperun.util.NodeCache,com.hoperun.shape.Circle,com.hoperun.node.Text,com.hoperun.node.Table,com.hoperun.node.Cell,com.hoperun.node.Image
 * @author xuliyu
 */
com.hoperun.node.Sheet = function(){
	com.hoperun.node.Sheet.superClass.constructor.call(this);
...
com.hoperun.util.BaseTool.extend(com.hoperun.node.Sheet,com.hoperun.node.Node);

com.hoperun.util.BaseTool.augment(com.hoperun.node.Sheet,{
    ///////////////////////////////////////////////////////////////////////////////////////
    ...
    _registerSheetListener: function (sheetDivObj) {
        ...
        $(sheetDivObj).droppable({
            ...
            drop: function (event, ui) {
                ...
                var targetPageDivObjPos = com.hoperun.util.BaseTool.getAbsPostionInContainer(targetDivObj);
...
//                      com.hoperun.util.BaseTool.doValidPosition(self, item);
        ...
        $(sheetDivObj).click(function (evt) {
            var relativePos = com.hoperun.util.BaseTool.getRelativeCoordinates(evt, sheetDivObj);
    ...
    */
    ...
    setData: function (data) {
        ...
        for (var i = 0; data.childNodes != null && i < data.childNodes.length; i++) {
            var node = com.hoperun.util.BaseTool.createNode(data.childNodes[i].type);
