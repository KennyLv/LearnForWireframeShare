 ...
 * @import com.hoperun.util.BaseTool, com.hoperun.util.NodeCache, com.hoperun.shape
 * @author xuliyu, Jian.T
 */
com.hoperun.node.Slide = function(){
	com.hoperun.node.Slide.superClass.constructor.call(this);
...
com.hoperun.util.BaseTool.extend(com.hoperun.node.Slide,com.hoperun.node.Node);

com.hoperun.util.BaseTool.augment(com.hoperun.node.Slide,{
...
//                      com.hoperun.util.BaseTool.doValidPosition(self, item);
		...
		$(this._domInstance).bind('click', function(evt){
			var relativePos =  com.hoperun.util.BaseTool.getOffset(evt);
