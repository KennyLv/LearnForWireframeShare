 ...
 * @author Feng.Lu
 */
com.hoperun.node.chart.Chart = function() {
    com.hoperun.node.chart.Chart.superClass.constructor.call(this);
};

//Extend based Node
com.hoperun.util.BaseTool.extend(com.hoperun.node.chart.Chart, com.hoperun.node.Node);

/**
 * The prototype for Base Chart.
 */
com.hoperun.util.BaseTool.augment(com.hoperun.node.chart.Chart,{
...
// └─────────────────────────────────────────────────────────────────────┘ \\
    ...
    setChartData : function(data) {
        com.hoperun.util.BaseTool.throwImplementException(this, "setChartData");
    },
    ...
    getChartData : function() {
        com.hoperun.util.BaseTool.throwImplementException(this, "getChartData");
    },
...
// └─────────────────────────────────────────────────────────────────────┘ \\
    ...
    createDomInstance : function(chartType) {
        ...
        com.hoperun.util.BaseTool.addForbiddenPropagation(this.getDomInstance());
        ...
        $(this._imgInstanceDot).bind('click', function(e){
            ...
            setTimeout(function(evt){
                if(!obj.hasClass('noClick')){
                    ...
                    message.id = com.hoperun.util.Observer.MessageType.CHART_FOCUS;
