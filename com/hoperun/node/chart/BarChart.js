 ...
 * @author Feng.Lu
 */
com.hoperun.node.chart.BarChart = function() {
    com.hoperun.node.chart.BarChart.superClass.constructor.call(this);
    this.createDomInstance("Chart_BarChart");
};

//Extend based Node
com.hoperun.util.BaseTool.extend(com.hoperun.node.chart.BarChart, com.hoperun.node.chart.Chart);

/**
 * The prototype for the pie chart.
 */
com.hoperun.util.BaseTool.augment(com.hoperun.node.chart.BarChart,{
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    /////////////////////////////// Private Properties   ////////////////////////////////////////////// 
    //Position
     ...
     */
    render: function(){
        com.hoperun.helper.ChartHelper.applyBaseAttr(this);
...
//        r.g.hbarchart(10, 250 + moveDownHeight, 300, 220, barData).hover(fin, fout);
     ...
     */
    getBarData: function(){
        var rowNum = com.hoperun.util.BaseTool.getRandomNum(2) + 2,
            colNum = com.hoperun.util.BaseTool.getRandomNum(2) + 4;
        
        var randomData = [];
        for(var i=0; i<rowNum; i++){
            var rowData = [];
            for(var j=0; j<colNum; j++){
                rowData.push(com.hoperun.util.BaseTool.getRandomNum(100));
            }
