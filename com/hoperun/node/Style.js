 ...
 * @author lu_feng
 */
com.hoperun.node.Style = function(){
...
vertical-align:baseline;
*/
com.hoperun.node.Style.prototype = {
	// Basic style storage
	...
	setBackground:function(_background) {
		this._background = null; //com.hoperun.util.BaseTool.rgb2hex(_background);
	},
	...
	copyToDom: function(obj){
		com.hoperun.util.BaseTool.setStyleProperty(obj.style, 'font-weight', this._bold == null ? this._bold : (this._bold ? "bold" : "normal") );
		com.hoperun.util.BaseTool.setStyleProperty(obj.style, 'font-family', this._fontFamily );
		com.hoperun.util.BaseTool.setStyleProperty(obj.style, 'font-size', this._fontSize == null ? this._fontSize : this._fontSize );
		com.hoperun.util.BaseTool.setStyleProperty(obj.style, 'font-style', this._italic == null ? this._italic : (this._italic ? "italic" : "normal") );
		var textDecoration = "";
		...
		com.hoperun.util.BaseTool.setStyleProperty(obj.style, 'text-decoration', textDecoration );
		
		com.hoperun.util.BaseTool.setStyleProperty(obj.style, 'color', this._color );
		//com.hoperun.util.BaseTool.setStyleProperty(obj.style, 'background-color', this._background );
		com.hoperun.util.BaseTool.setStyleProperty(obj.style, 'vertical-align', this._verticalAlign );
	},
