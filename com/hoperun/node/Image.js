 ...
 * @author Jian.T
 */
com.hoperun.node.Image = function() {
	com.hoperun.node.Image.superClass.constructor.call(this);
	this._type = "Image";
...
com.hoperun.util.BaseTool.extend(com.hoperun.node.Image,com.hoperun.node.Node);

com.hoperun.util.BaseTool.augment(com.hoperun.node.Image,{
	...
	doBlur: function(){
		...
		com.hoperun.util.BaseTool.setStyleProperties(this._imgInstance.style, {
			position: 'absolute'
		});
