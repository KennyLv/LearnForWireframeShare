 ...
 * @author Jian.T
 */
com.hoperun.node.shape.Line = function() {
	com.hoperun.node.shape.Star.superClass.constructor.call(this);
	this.createDomInstance('Shape_Line');
};
com.hoperun.util.BaseTool.extend(com.hoperun.node.shape.Line,
		com.hoperun.node.shape.Shape);

com.hoperun.util.BaseTool.augment(com.hoperun.node.shape.Line, {
	...
	render : function() {
		...
		com.hoperun.helper.ShapeHelper.drawLine(this);
	},
	...
	clone : function() {
		var cloneObj = new com.hoperun.shape.Line();
