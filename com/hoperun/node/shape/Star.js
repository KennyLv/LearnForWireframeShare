 ...
 * @author Jian.Tao
 */
com.hoperun.node.shape.Star = function() {

	com.hoperun.node.shape.Star.superClass.constructor.call(this);
	this.createDomInstance('Shape_Star');
};

com.hoperun.util.BaseTool.extend(com.hoperun.node.shape.Star,
		com.hoperun.node.shape.Shape);

com.hoperun.util.BaseTool.augment(com.hoperun.node.shape.Star, {
	...
	render : function() {
		...
		com.hoperun.helper.ShapeHelper.drawStar(this);
	},
