 ...
 * @author Jian.T
 */
com.hoperun.shape.AbnormityTriangle = function() {
	this._id = com.hoperun.util.BaseTool.uuid();
	this._domInstance = com.hoperun.util.ShapeHelper.createAbnormityTriangle({
		id : this._id,
		top : this._top,
		left : this._left,
...
com.hoperun.shape.AbnormityTriangle.prototype = {
	...
	_resize : function() {
		this._domInstance = com.hoperun.util.ShapeHelper
	...
	clone : function() {
		var cloneObj = new com.hoperun.shape.AbnormityTriangle();
