 ...
 * @author lu_feng
 */
if (!com.hoperun.event.KeyboardHandler) {
	com.hoperun.event.KeyboardHandler = function() {
	};
	
	com.hoperun.event.KeyboardHandler.prototype = {
		isHandlerFlag:false,
		_type: null,
...
//
				...
				message.id = com.hoperun.util.Observer.MessageType.KEYBOARD_COMMAND;
				message.sender = this;
		...
		keypressHandler: function(evt){
		    ...
		    if(keyCode>=32 && keyCode<=126){
			    ...
			    var message = new com.hoperun.util.Observer.Message();
				message.id = com.hoperun.util.Observer.MessageType.KEYBOARD_INPUT;
				message.sender = this;
