 ...
 *         com.hoperun.tracker.ImageTracker
 * @author lu_feng
 */
if (!com.hoperun.event.ImageFocusListener) {
    com.hoperun.event.ImageFocusListener = function () {
        var tracker = null;
        this.update = function (message) {
            if (!tracker) {
                tracker = new com.hoperun.tracker.ImageTracker();
            }
	...
	com.hoperun.event.ImageInsertListener = function() {
		this.update = function(message) {
			var src = message.data.src;
			var container = getActiveContainer();
			var image = new com.hoperun.node.Image();
			...
			jsk.execute(
				function() {
					...
					var imgResizeMsg = new com.hoperun.util.Observer.Message();
					imgResizeMsg.id = com.hoperun.util.Observer.MessageType.IMAGE_LAYOUT;
					imgResizeMsg.sender = image;
					imgResizeMsg.data = {};
					com.hoperun.util.Observer.sendMessage(imgResizeMsg);
	...
	com.hoperun.event.ImageResizeListener = function() {
		this.update = function(message) {
			...
			jsk.execute(
				function() {
					...
					focusMsg.id = com.hoperun.util.Observer.MessageType.IMAGE_FOCUS;
...
//					image.setLeft(image.getLeft() - moveL);
	...
	com.hoperun.event.ImageClipListener = function() {
		this.update = function(message) {
			var tracker = message.sender;
			var imgItem = tracker.getActiveItem();
			...
			jsk.execute(
				...
				function(data) {
					...
					var slideMessage = new com.hoperun.util.Observer.Message();
					slideMessage.id = com.hoperun.util.Observer.MessageType.UPDATE_SLIDE_LEFTSIDE;
					slideMessage.sender = image;
					slideMessage.data = {};
					com.hoperun.util.Observer.sendMessage(slideMessage);
				}
			);
		};
	};

	com.hoperun.event.ImageStyleListener = function() {
		this.update = function(message) {
...
//					}
	...
	com.hoperun.event.ImageMoveListner = function(){
		this.update = function(message) {
			var image = message.sender;
			...
			if(message.data.rect){
				com.hoperun.util.BaseTool.doValidPositionWidthRect(message.data.rect, image);
			}
			else{
				com.hoperun.util.BaseTool.doValidPosition(message.data.self, image);
			}
			...
			jsk.execute( function () {
				...
				updateMsg.id = com.hoperun.util.Observer.MessageType.IMAGE_LAYOUT;
	...
	com.hoperun.util.Observer.register(
			com.hoperun.util.Observer.MessageType.IMAGE_INSERT,
			new com.hoperun.event.ImageInsertListener());

	com.hoperun.util.Observer.register(
			com.hoperun.util.Observer.MessageType.IMAGE_SETSTYLE,
			new com.hoperun.event.ImageStyleListener());

	// Register this into Observer container.
	var ImageFocusListener = new com.hoperun.event.ImageFocusListener();
	com.hoperun.util.Observer.register(com.hoperun.util.Observer.MessageType.IMAGE_FOCUS, ImageFocusListener);
	com.hoperun.util.Observer.register(com.hoperun.util.Observer.MessageType.IMAGE_RIGHTCLICK, ImageFocusListener);

	com.hoperun.util.Observer.register(
			com.hoperun.util.Observer.MessageType.IMAGE_RESIZE,
			new com.hoperun.event.ImageResizeListener());
	com.hoperun.util.Observer.register(
			com.hoperun.util.Observer.MessageType.IMAGE_POSITION,
			new com.hoperun.event.ImageMoveListner());
	com.hoperun.util.Observer.register(
			com.hoperun.util.Observer.MessageType.IMAGE_CLIP,
			new com.hoperun.event.ImageClipListener());
}