 ...
 * @author lu_feng
 */
if (!com.hoperun.event.ParagraphListener) {
	com.hoperun.event.ParagraphListener = function() {
		this._pageObj = null; 
		this._selectedShape = null; 
			
		this.update = function(message) {
			//alert("Begin Execute Paragraph ");
			if(message.id == com.hoperun.util.Observer.MessageType.DOCUMENT_CREATE){
				...
				com.hoperun.util.Observer.register(com.hoperun.util.Observer.MessageType.PARAGRAPH_STYLE, this);
				
				com.hoperun.util.Observer.register(com.hoperun.util.Observer.MessageType.PARAGRAPH_ACTION, this);
			}
			else if(message.id == com.hoperun.util.Observer.MessageType.PARAGRAPH_STYLE){
			...
			else if(message.id == com.hoperun.util.Observer.MessageType.PARAGRAPH_ACTION){
	...
	//(function(){
		var listener = new com.hoperun.event.ParagraphListener();
		com.hoperun.util.Observer.register(com.hoperun.util.Observer.MessageType.DOCUMENT_CREATE, listener);
	//})();
