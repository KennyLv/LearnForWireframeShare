com.hoperun.util.Aop = function() {
	this._id = com.hoperun.util.BaseTool.uuid();
	this._type = "Aop";
};

com.hoperun.util.Aop.prototype = {
	...
	beforeHander : function(object, fnName) {
		...
		//com.hoperun.util.BaseTool.log4js('DEBUG', 'ID: ' + object._id + " Type: " + object._type + " --- Before " + fnName);
	...
	afterHander : function(object, fnName) {
		...
		//com.hoperun.util.BaseTool.log4js('DEBUG', 'ID: ' + object._id + " Type: " + object._type + " --- After " + fnName);
	...
	aroundHander : function(object, fnName) {
		...
		com.hoperun.util.BaseTool.log4js('DEBUG', 'ID: ' + object._id + " Type: " + object._type + " --- Around " + fnName);
	}
};