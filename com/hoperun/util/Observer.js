 ...
 * @author xuliyu
 */
if (!com.hoperun.util.Observer) {
	com.hoperun.util.Observer = {
		_messageTable : new com.hoperun.util.Hashtable(),
		...
		register : function(messageId, object) {
			...
			if (!com.hoperun.util.Observer._messageTable.contains(messageId)) {
				var objectList = [];
				objectList.add(object);
				com.hoperun.util.Observer._messageTable.add(messageId, objectList);
			} else
				com.hoperun.util.Observer._messageTable.items(messageId).add(object);
		},

		unregister : function(messageId, object) {
			var objectList = com.hoperun.util.Observer._messageTable.items(messageId);
		...
		sendMessage : function(message) {
			...
			//function exec() {
				//alert(message.id);
				var objectList = com.hoperun.util.Observer._messageTable.items(message.id);
...
if (!com.hoperun.util.Observer.MessageType) {
    com.hoperun.util.Observer.CommonMessageType = {
       Node: {
           INSERT: "NODE_INSERT",
           FOCUS: "NODE_FOCUS",
           RESIZE: "NODE_RESIZE",
    ...
    com.hoperun.util.Observer.MessageType = {
        NEW_HOPERUN_PAPERS: 'NEW_HOPERUN_PAPERS',
        NEW_HOPERUN_SHEETS: 'NEW_HOPERUN_SHEETS',
        NEW_HOPERUN_PRESENTATIONS: 'NEW_HOPERUN_PRESENTATIONS',
