 ...
 * @author lu_feng
 */
com.hoperun.tracker.CellTracker = function() {
	...
	this._className = "com.hoperun.tracker.CellTracker";
	...
	$(this._colBtn).mousedown(function(e){
		...
		var callback = function(x, y, isUndoFlag){
			...
			message.id = com.hoperun.util.Observer.MessageType.TABLE_COL_WIDTH_CHANGE;
			message.sender = self;
		...
		com.hoperun.util.BaseTool.fDragging(this, e, false, callback, callback, table);
	});
	$(this._rowBtn).mousedown(function(e){
		var mouseY = e.clientY;
		var callback = function(x, y, isUndoFlag){
			var message = new com.hoperun.util.Observer.Message();
			message.id = com.hoperun.util.Observer.MessageType.TABLE_ROW_HEIGHT_CHANGE;
			message.sender = self;
	...
	this._cellMenu = new com.hoperun.tracker.CellMenu();
	this._cellMenu.appendTo(this);
	this.hide();
};
com.hoperun.tracker.CellTracker.FlagType = {
	Horizontal : 'Horizontal',
	Vertical : 'Vertical',
	None : 'None'
};
com.hoperun.tracker.CellTracker.prototype = {
...
//			alert(row1 + ' , ' + row2 + ' , ' + col1 + ' , ' + col2);
	...
	refresh:function(cells, flag){
		...
		var self = this;
		if (this._flag == com.hoperun.tracker.CellTracker.FlagType.Horizontal) {
			//row handler
		...
		else if(this._flag == com.hoperun.tracker.CellTracker.FlagType.None){
	...
	_changeTableSelection: function(cells){
		...
		if(minRow <= maxRow && minCol <= maxCol && this._activeTable){
			var selection = new com.hoperun.model.TableSelection(minRow, minCol, maxRow - minRow + 1, maxCol - minCol + 1);
