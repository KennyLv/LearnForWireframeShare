 ...
 * @author lu_feng
 */
com.hoperun.tracker.TableTracker = function() {
	...
	this._className = "com.hoperun.tracker.TableTracker";
	...
	this._rightTopBtn.onclick = function(){
		...
		message.id = com.hoperun.util.Observer.MessageType.TABLE_COL_ADD;
		message.sender = self.getActiveTable();
		com.hoperun.util.Observer.sendMessage(message);
	};
	this._leftBottomBtn.onclick = function(){
		var addRowMsg = new com.hoperun.util.Observer.Message();
		addRowMsg.id = com.hoperun.util.Observer.MessageType.TABLE_ROW_ADD;
		addRowMsg.sender = self.getActiveTable();
		com.hoperun.util.Observer.sendMessage(addRowMsg);
    ...
    this._leftTopBtn.ondblclick = function () {
        com.hoperun.event.ContextMenuEvent.show(self.getActiveTable());
    };
	this._leftBar.onclick = function(e){
		var message = new com.hoperun.util.Observer.Message();
		message.id = com.hoperun.util.Observer.MessageType.TABLE_ROW_SELECT;
		message.sender = self.getActiveTable();
		message.data = {e:e};
		com.hoperun.util.Observer.sendMessage(message);
	};
	...
	this._topBar.onclick = function(e){
		var message = new com.hoperun.util.Observer.Message();
		message.id = com.hoperun.util.Observer.MessageType.TABLE_COL_SELECT;
		message.sender = self.getActiveTable();
		message.data = {e:e};
		com.hoperun.util.Observer.sendMessage(message);
	};
...
<div style='position:absolutely;width:100%;height:100%;'>
	...
	*/
	...
	// this._domInstance.onclick = com.hoperun.event.MouseEvent.click;
};
com.hoperun.tracker.TableTracker.prototype= {
	...
	setActiveTable:function(activeTable){
		...
		var pos = com.hoperun.util.BaseTool.getAbsPostionInContainer(this._activeTable.getDomInstance());
	...
	setLeft:function(left){
		this._left = left;
		this._domInstance.style.left = com.hoperun.util.BaseTool.convertPixelToNumber(left) - 15 + "px"; //Balance border left width
	},
	
	setTop:function(top){
		this._top = top;
		this._domInstance.style.top = com.hoperun.util.BaseTool.convertPixelToNumber(top)-15; //Balance border top width
	},
	...
	setWidth:function(width){
		this._width = com.hoperun.util.BaseTool.convertPixelToNumber(width) + "px";
		this._domInstance.style.width = com.hoperun.util.BaseTool.convertPixelToNumber(width) + "px";
		this._rightTopBtn.style.left = com.hoperun.util.BaseTool.convertPixelToNumber(width) + 10 + 5 + 5 + "px";
		this._topBar.style.width = com.hoperun.util.BaseTool.convertPixelToNumber(width-16) + "px";
	},
	
	setHeight:function(height){
		this._height = height;
		this._domInstance.style.height = com.hoperun.util.BaseTool.convertPixelToNumber(height) + "px";
		this._leftBottomBtn.style.top = com.hoperun.util.BaseTool.convertPixelToNumber(height) + 10 + 5 + 5 + "px";
		this._leftBar.style.height = com.hoperun.util.BaseTool.convertPixelToNumber(height-16) + "px";
	},
