 ...
 * @author lu_feng
 */
com.hoperun.tracker.CellMenu = function() {
	...
	this._className = "com.hoperun.tracker.CellMenu";
	this._type = "CellMenu";
	// com.hoperun.util.NodeCache.add(this.getId(), this);

	this._insert = new com.hoperun.tracker.CellButton();
	this._insert.setText("Insert");
	this._insert.appendTo(this);
	this._insert.setMessageType(com.hoperun.util.Observer.MessageType.CELL_MENU_INSERT);
	this._insert.initClick();
	this._delete = new com.hoperun.tracker.CellButton();
	this._delete.setText("Delete");
	this._delete.setMessageType(com.hoperun.util.Observer.MessageType.CELL_MENU_DELETE);
	this._delete.appendTo(this);
	this._delete.initClick();
};
com.hoperun.tracker.CellMenu.FlagType = {
	Horizontal : 'Horizontal',
	Vertical : 'Vertical',
	None : 'None'
};
com.hoperun.tracker.CellMenu.prototype = {
