 ...
 * @author Jian.T
 */
com.kenny.tracker.LineTracker = function() {
	this._id = com.kenny.util.BaseTool.uuid();
	this._className = "com.kenny.tracker.LineTracker";
...
com.kenny.tracker.LineTracker.prototype = {
	...
	_registerMouseEvent : function() {
		...
		this._domInstanceBtn1.onmousedown = function(evt) {
			...
			document.body.onmouseup = function(evt) {
				...
				shapeResizeMsg.id = com.kenny.util.Observer.MessageType.SHAPE_RESIZE;
	...
	setActiveItem : function(item) {
		...
		message.id = com.kenny.util.Observer.MessageType.CONTEXT_FOCUS;
		message.sender = this;
