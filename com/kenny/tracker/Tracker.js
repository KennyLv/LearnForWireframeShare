 ...
 * @author feng.lu
 */
com.kenny.tracker.Tracker = function() {
};
com.kenny.tracker.Tracker.prototype = {
    ...
    setActiveItem : function(item) {
        ...
        this._top = pos.y;
        this._left = pos.x;
        this._width = com.kenny.util.BaseTool.convertPixelToNumber(this._activeItem.getDomInstance().style.width);
        this._height = com.kenny.util.BaseTool.convertPixelToNumber(this._activeItem.getDomInstance().style.height);
        ...
        focusMsg.id = com.kenny.util.Observer.MessageType.CONTEXT_FOCUS; 
        ...
        for ( var i = 0; i < this._buttons.length; i++) {
            this._buttons[i].onmousedown = function(evt) {
                ...
                document.body.onmouseup = function(evt) {
                    ...
                    var resizeMsg = new com.kenny.util.Observer.Message();
                    resizeMsg.id = com.kenny.util.BaseTool.getMsgType("resize", self.getActiveItem());
                    resizeMsg.sender = self;
                    resizeMsg.data = {'zoomX':zoomX, 'zoomY':zoomY, 'moveTop':moveTop, 'moveLeft':moveLeft};
                    com.kenny.util.Observer.sendMessage(resizeMsg);
                    
                    var updateMsg = new com.kenny.util.Observer.Message();
                    updateMsg.id = com.kenny.util.BaseTool.getMsgType("layout", self.getActiveItem()); 
