 ...
 * @author lu_feng
 */
com.kenny.tracker.TableMenu = function() {
	...
	this._className = "com.kenny.tracker.TableMenu";
	this._type = "TableMenu";

	this._delete = new com.kenny.tracker.CellButton();
	this._delete.setText("Delete");
	this._delete.setMessageType(com.kenny.util.Observer.MessageType.TABLE_MENU_DELETE);
	this._delete.appendTo(this);
	this._delete.initClick();
};

com.kenny.tracker.TableMenu.hideAll = function(){
	$('.table-menu').hide();
};
com.kenny.tracker.TableMenu.FlagType = {
	Horizontal : 'Horizontal',
	Vertical : 'Vertical',
	None : 'None'
};
com.kenny.tracker.TableMenu.prototype = {
