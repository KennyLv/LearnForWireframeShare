 ...
 * @author kenny
 */
com.kenny.tracker.VideoTracker = function () {
    ...
    this._className = "com.kenny.tracker.VideoTracker";
    ...
    this._CloseBtn.onclick = function () {
        ...
        message.id = com.kenny.util.Observer.MessageType.DELETE_ITEM;
...
//
			var shapeResizeMsg = new com.kenny.util.Observer.Message();
			shapeResizeMsg.id = com.kenny.util.Observer.MessageType.VIDEO_RESIZE;
			shapeResizeMsg.sender = self;
			shapeResizeMsg.data = {'newWidth':newWidth,'newHeight':newHeight};
			com.kenny.util.Observer.sendMessage(shapeResizeMsg);
		};
	};
	...
	this._TopBar.onmousedown = function(evt) {
		...
		document.body.onmouseup = function(evt) {
			...
			var shapeMoveMsg = new com.kenny.util.Observer.Message();
			shapeMoveMsg.id = com.kenny.util.Observer.MessageType.VIDEO_POSITION;
			shapeMoveMsg.sender = self;
			shapeMoveMsg.data = {'moveTop':diffT, 'moveLeft':diffL};
			com.kenny.util.Observer.sendMessage(shapeMoveMsg);
		};
	};
};
com.kenny.tracker.VideoTracker.prototype = {
    ...
    setActiveItem: function (activeVideo) {
        ...
        var pos = com.kenny.util.BaseTool.getAbsPostionInContainer(this._activeVideo.getDomInstance());
    ...
    setWidth: function (width) {
        ...
        this._domInstance.style.width = com.kenny.util.BaseTool.convertPixelToNumber(width+4) + "px";
        this._TopBar.style.width = com.kenny.util.BaseTool.convertPixelToNumber(width + 4) + "px";
        this._BottomBar.style.width = com.kenny.util.BaseTool.convertPixelToNumber(width + 4) + "px";
        //this._RightBar.style.right = com.kenny.util.BaseTool.convertPixelToNumber(width + 2) + "px";
    },

    setHeight: function (height) {
        this._height = height;

        this._domInstance.style.height = com.kenny.util.BaseTool.convertPixelToNumber(height+35) + "px";
        this._LeftBar.style.height = com.kenny.util.BaseTool.convertPixelToNumber(height+35)+ "px";
        this._RightBar.style.height = com.kenny.util.BaseTool.convertPixelToNumber(height+35) + "px";
    },
    getWidth: function () {
        return this._width;
    },
