com.kenny.node.Text = function(){
	
	com.kenny.node.Text.superClass.constructor.call(this);
...
com.kenny.util.BaseTool.extend(com.kenny.node.Text,com.kenny.node.Node);

com.kenny.node.Text.prototype.getDomInstance =  function(){
	if (!this._domInstance){
		...
		$(this._domInstance).bind('mousedown', com.kenny.event.MouseEvent.mouseDown).bind('mouseup', com.kenny.event.MouseEvent.mouseUp);
	}
	return this._domInstance;
	
};

com.kenny.node.Text.prototype.renderTo = function(container){
...
com.kenny.node.Text.prototype.setData = function(data){
	this._data  = data;
};

com.kenny.node.Text.prototype.getData = function(){
	//TODO gather the data of self and the children
};



com.kenny.node.Page = function(){
	
	com.kenny.node.Page.superClass.constructor.call(this);
...
com.kenny.util.BaseTool.extend(com.kenny.node.Page,com.kenny.node.Node);

com.kenny.node.Page.prototype.getDomInstance = function(){
	if (!this._domInstance ){
		this._domInstance = document.createElement("DIV");
	}
...
com.kenny.node.Page.prototype.render = function(){
...
com.kenny.node.Page.prototype.getHeight = function(){
	return this._height;
};

com.kenny.node.Page.prototype.setHeight = function(height){
	this._height = height;
};

com.kenny.node.Page.prototype.getWidth = function(){
	return this._width;
};

com.kenny.node.Page.prototype.setWidth = function(width){
	this._width = width;
};

com.kenny.node.Page.prototype.setPadding = function(padding){
	this._padding = padding;
};

com.kenny.node.Page.prototype.getPadding = function(){
	return this._padding;
};

com.kenny.node.Page.prototype.setHeader = function(header){
	this._header = header;
	header.setParent(this);
};

com.kenny.node.Page.prototype.getHeader = function(){
	return this._header;
};

com.kenny.node.Page.prototype.setFooter = function(footer){
	this._footer = footer;
	footer.setParent(this);
};

com.kenny.node.Page.prototype.getFooter = function(){
	return this._footer;
};

com.kenny.node.Page.prototype.getOccupiedHeight = function(){
...
com.kenny.node.Page.prototype.setNodes = function(nodes){
	if (nodes){
		this._nodes = nodes;
	}
};

com.kenny.node.Page.prototype.popLine = function(){
...
com.kenny.node.Page.prototype.getAvailablePosition = function(top, height, paddingLeft, paddingRight){
...
com.kenny.node.Line = function(){
	
	com.kenny.node.Line.superClass.constructor.call(this);
...
com.kenny.util.BaseTool.extend(com.kenny.node.Line,com.kenny.node.Node);

com.kenny.node.Line.prototype.getDomInstance = function(){
	if (!this._domInstance ){
		this._domInstance = document.createElement("DIV");
	}
...
com.kenny.node.Line.prototype.render = function(){
	var domInstance = this.getDomInstance();
...
com.kenny.node.Line.prototype.getHeight = function(){
	var maxHeight = 0;
	var sectionHeight;
...
com.kenny.node.Line.prototype.getHoldHeight = function(){
	return this.getHeight() + this._paddingTop;
};

com.kenny.node.Line.prototype.getWidth = function(){
	return this._width;
};

com.kenny.node.Line.prototype.setWidth = function(width){
	this._width = width;
};

com.kenny.node.Line.prototype.getOccupiedWidth = function(){
...
com.kenny.node.Line.prototype.getFirstIndent = function(){
	return this._firstIndent;
};

com.kenny.node.Line.prototype.setFirstIndent = function(firstIndent){
	this._firstIndent = firstIndent;
};

com.kenny.node.Line.prototype.getLeftIndent = function(){
	return this._leftIndent;
};

com.kenny.node.Line.prototype.setLeftIndent = function(leftIndent){
	this._leftIndent = leftIndent;
};

com.kenny.node.Line.prototype.getRightIndent = function(){
	return this._rightIndent;
};

com.kenny.node.Line.prototype.setRightIndent = function(rightIndent){
	this._rightIndent = rightIndent;
};

com.kenny.node.Line.prototype.getTextAlign = function(){
	return this._textAlign;
};

com.kenny.node.Line.prototype.setTextAlign = function(textAlign){
	this._textAlign = textAlign;
};

com.kenny.node.Line.prototype.setTextLineSpacing = function(textLineSpacing){
	this._textLineSpacing = textLineSpacing;
};

com.kenny.node.Line.prototype.peek = function(){
...
com.kenny.node.Line.prototype.setPaddingTop = function(paddingTop){
	this._paddingTop = paddingTop;
};

com.kenny.node.Line.prototype.getPaddingTop = function(){
	return this._paddingTop;
};

com.kenny.node.Line.prototype.getTop = function(){
...
com.kenny.node.Line.prototype.shiftSection = function(){
	if (this._children.length == 0){
		return null;
	}
...
com.kenny.node.Line.prototype.getNextLine = function(){
...
com.kenny.node.Line.prototype.repair = function(){
	...
	for (var i = 0 ; i < availableWidths.length; i++){
		...
		if (currWidth > availableWidths[i].width){
			...
			if (leftWidth > 0){
				var splitSection  = new com.kenny.node.Section();
...
com.kenny.node.Section = function(){
	
	com.kenny.node.Section.superClass.constructor.call(this);
...
com.kenny.util.BaseTool.extend(com.kenny.node.Section,com.kenny.node.Node);

com.kenny.node.Section.prototype.getDomInstance = function(){
...
com.kenny.node.Section.prototype.render = function(){
...
com.kenny.node.Section.prototype.getText = function(){
	return this._text;
};

com.kenny.node.Section.prototype.setText = function(text){
	this._text = text;
};

com.kenny.node.Section.prototype.setStyle = function(style){
	this._style = style;
};

com.kenny.node.Section.prototype.getStyle = function(){
	return this._style;
};

com.kenny.node.Section.prototype.insert = function(text,index){
	if (index >= 0){
...
com.kenny.node.Section.prototype.remove = function(from, to){
	this._text = this._text.substring(0,from) + this._text.substring(to);
};

com.kenny.node.Section.prototype.getWidth = function(){
	...
	if (domInstance && !this.isEmpty()){
		...
		var textHelper = com.kenny.util.TextHelper;
...
com.kenny.node.Section.prototype.getHeight = function(){
	var textHelper = com.kenny.util.TextHelper;
	textHelper.changeStyle(this._style);
	return textHelper.getRect(this._text).height;
};

com.kenny.node.Section.prototype.getHoldWidth = function(){
	return this.getWidth() + this._paddingLeft; 
};

com.kenny.node.Section.prototype.isBreakParagraph = function(){
	return this._text.charAt(this._text.length - 1) === "\n";
};

com.kenny.node.Section.prototype.shiftWord = function(){
	if (this.isEmpty()){
		return "";
	}
...
com.kenny.node.Section.prototype.popWord = function(){
	if (this.isEmpty()){
		return "";
	}
...
com.kenny.node.Section.prototype.isEmpty = function(){
...
com.kenny.node.Section.prototype.setPaddingLeft = function(paddingLeft){
	this._paddingLeft = paddingLeft;
};

com.kenny.node.Section.prototype.getPaddingLeft = function(){
	return this.paddingLeft;
};


com.kenny.node.Header = function(){
	
	com.kenny.node.Header.superClass.constructor.call(this);
...
com.kenny.util.BaseTool.extend(com.kenny.node.Header, com.kenny.node.Node);

com.kenny.node.Header.prototype.getDomInstance = function(){
	if (!this._domInstance ){
		this._domInstance = document.createElement("DIV");
...
com.kenny.node.Header.prototype.render = function(){
...
com.kenny.node.Header.prototype.setText = function(text){
	this._text = text;
};

com.kenny.node.Header.prototype.setAlign = function(align){
	this._align = align;
};

com.kenny.node.Header.prototype.setHeight = function(height){
	this._height = height;
};

com.kenny.node.Footer = function(){
	
	com.kenny.node.Footer.superClass.constructor.call(this);
...
com.kenny.util.BaseTool.extend(com.kenny.node.Footer, com.kenny.node.Node);

com.kenny.node.Footer.prototype.getDomInstance = function(){
	if (!this._domInstance ){
		this._domInstance = document.createElement("DIV");
...
com.kenny.node.Footer.prototype.render = function(){
...
com.kenny.node.Footer.prototype.setText = function(text){
	this._text = text;
};

com.kenny.node.Footer.prototype.setAlign = function(align){
	this._align = align;
};

com.kenny.node.Footer.prototype.setHeight = function(height){
	this._height = height;
};
...
var SimpleFlowCompositor = (function(){
	...
	var composePages = function(count){
		...
		while( (!count || composition.getChildren().length < count) && (sections.length !== 0 || genSection())){
			var page = new com.kenny.node.Page();
				
			if (setting){
				var header = new com.kenny.node.Header();
				header.setText(setting.header.text);
				header.setAlign(setting.header.align);
							
				var footer = new com.kenny.node.Footer();
		...
		function genSection(){
			//break the sections
			if (styles.length > 0){
				var section = new com.kenny.node.Section();
		...
		function genTextLine(page, sections, currLineTop){
			var line = new com.kenny.node.Line();
	...
	return {
		...
		compose: function(adata){
			...
			com.kenny.util.TextStyleContainerUtils.setAllData(data.styles, true);
			...
			for (var i = 0 ; i < data.texts.length; i++){
				...
				for (var j = 0 ; j < data.texts[i].style.length ; j++){
					...
					var styleObj = com.kenny.util.TextStyleContainerUtils.getById(data.texts[i].style[j].style).clone();
			...
			for (var i = 0 ; i < data.nodes.length; i++){
				...
				for (var i = 0 ; i < pageNodes.length ; i++){
				    var node = com.kenny.util.BaseTool.createNode(pageNodes[i].type);
