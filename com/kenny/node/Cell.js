 ...
 * @author xuliyu
 */
com.kenny.node.Cell = function() {
	com.kenny.node.Cell.superClass.constructor.call(this);
	...
	var self = this;
	this._domInstance.addEventListener('click', function(event){com.kenny.event.MouseEvent.click(event, self);$('.tracker-menu').css('display','none');}, true);
...
com.kenny.util.BaseTool.extend(com.kenny.node.Cell,com.kenny.node.Node);

com.kenny.util.BaseTool.augment(com.kenny.node.Cell,{
    ...
    updateCellBorderWidth: function (borderWidthPropertyKey, width) {
        ...
        if (value) {
            com.kenny.util.BaseTool.setStyleProperty(this._domInstance.style, borderWidthPropertyKey, value);
        }
    },
