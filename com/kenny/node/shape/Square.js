 ...
 * @author Jian.T
 */
com.kenny.shape.Square = function() {
	this._id = com.kenny.util.BaseTool.uuid();
	this._domInstance = com.kenny.util.ShapeHelper.createRectangle({
		id : this._id,
		top : this._top,
		left : this._left,
		width : this._width,
...
com.kenny.shape.Square.prototype = {
	...
	_resize : function() {
		this._domInstance = com.kenny.util.ShapeHelper.updateRectangle(
				this._domInstance, {
	...
	clone : function() {
		var cloneObj = new com.kenny.shape.Square();
