 ...
 * @author Jian.T
 */
com.kenny.shape.SingleArrow = function() {
	this._id = com.kenny.util.BaseTool.uuid();
	this._domInstance = com.kenny.util.ShapeHelper.createArrow({
		id : this._id,
		...
		fofontContent : this._fontContent,
		zIndex : this._zIndex
	});
	this._type = "SingleArrow";
...
com.kenny.shape.SingleArrow.prototype = {
	...
	_resize : function() {
		this._domInstance = com.kenny.util.ShapeHelper.updateArrow(
				this._domInstance, {
					arrowType : this._arrowType,
					top : this._top,
					left : this._left,
	...
	clone : function() {
		var cloneObj = new com.kenny.shape.SingleArrow();
