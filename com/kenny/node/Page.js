...
com.kenny.node.Page = function(){
    ...
    message.id = com.kenny.util.Observer.MessageType.DOCUMENT_CREATE;
    message.sender = this;
...
com.kenny.util.BaseTool.augment(com.kenny.node.Page,{
	...
	sendSelectionChangeNotify: function(){
		...
		if(selection){
			...
			var keyBoardFocus = new com.kenny.util.Observer.Message();
			keyBoardFocus.id = com.kenny.util.Observer.MessageType.KEYBOARD_FOCUS;
            com.kenny.util.Observer.sendMessage(keyBoardFocus);
	...
	_registerPageListener: function(pageDivObj){
		...
		$(pageDivObj).click(function(e){
			...
			var relativePos = com.kenny.util.BaseTool.getRelativeCoordinates(e, pageDivObj);
		...
		$(pageDivObj).droppable({
	        ...
	        drop: function(event, ui) { 
        		...
        		var targetPageDivObjPos = com.kenny.util.BaseTool.getAbsPostionInContainer(targetPageDivObj);
...
//                      com.kenny.util.BaseTool.doValidPosition(self, item);
	...
	_createPage: function(){
		...
		pageDivObj.id = com.kenny.util.BaseTool.uuid();
		pageDivObj.className = "hr-page hr-page-paginated";
		com.kenny.util.BaseTool.setStyleProperty(pageDivObj.style, 'width', this._width+'px');
		com.kenny.util.BaseTool.setStyleProperty(pageDivObj.style, 'height', this._height+'px');
		com.kenny.util.BaseTool.setStyleProperty(pageDivObj.style, 'text-align', 'left');
		com.kenny.util.BaseTool.setStyleProperty(pageDivObj.style, 'background-color', 'rgb(255, 255, 255)');
...
//		com.kenny.util.BaseTool.setStyleProperty(pageDivObj.style, 'padding-top', this._contentPadding.top+"px");
//		com.kenny.util.BaseTool.setStyleProperty(pageDivObj.style, 'padding-bottom', this._contentPadding.bottom+"px");
		
//		//TODO: Need to take more consider about staff gauge
//		com.kenny.util.BaseTool.setStyleProperty(pageDivObj.style, 'padding-top', this._marginTop+"px");
//		com.kenny.util.BaseTool.setStyleProperty(pageDivObj.style, 'padding-right', this._marginRight+"px");
//		com.kenny.util.BaseTool.setStyleProperty(pageDivObj.style, 'padding-bottom', this._marginBottom+"px");
//		com.kenny.util.BaseTool.setStyleProperty(pageDivObj.style, 'padding-left', this._marginLeft+"px");
	...
	setData:function(data){
		...
		if(data.texts){
			for(var i=0; i<data.texts.length; i++){
				var paragraph = new com.kenny.node.Paragraph();
			...
			for(var i=0; i<data.nodes.length; i++){
				...
				if(pageIndex!=null && pageNodes){
					for(var j=0; j<pageNodes.length; j++){
						...
						var node = com.kenny.util.BaseTool.createNode(nodeData.type);
	...
	getData:function(){
		...
		var styles = com.kenny.util.TextStyleContainerUtils.getAllData();
