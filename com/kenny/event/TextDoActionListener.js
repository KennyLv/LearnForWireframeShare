 ...
 */
 ...
 if (!com.kenny.event.TextDoActionListener) {
	com.kenny.event.TextDoActionListener = function() {
		...
		this.update = function(message) {
			...
			var selection = new com.kenny.model.TextSelectionModel(); //New selection		
			
			var isValidActionFlag = true;
			switch (message.id) {
				case com.kenny.util.Observer.MessageType.TEXT_ACTION_BACKSPACE_DELETE:
					this.doDeleteCharacter(container, selection, selectionData, message.data);
					break;
				case com.kenny.util.Observer.MessageType.TEXT_ACTION_ENTER:
					this.doEnter(container, selection, selectionData, message.data);
					break;
				case com.kenny.util.Observer.MessageType.PARAGRAPH_ACTION_DELETE:
					this.doCombineNextParagraph(container, selection, selectionData, message.data);
					break;	
				case com.kenny.util.Observer.MessageType.PARAGRAPH_ACTION_BACKSPACE:
					this.doCombinePreviousParagraph(container, selection, selectionData, message.data);
					break;
				case com.kenny.util.Observer.MessageType.TEXT_ACTION_COLLAPSED_BACKSPACE_DELETE:
					this.doDeleteSelection(container, selection, selectionData, message.data);
					break;
				case com.kenny.util.Observer.MessageType.TEXT_ACTION_INPUT:
					this.doInput(container, selection, selectionData, message.data);
					break;
				case com.kenny.util.Observer.MessageType.TEXT_ACTION_REPLACE:
	...
	com.kenny.event.TextDoActionListener.prototype = {
	...
	var textDoActionListener = new com.kenny.event.TextDoActionListener();
	com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.TEXT_ACTION_BACKSPACE_DELETE,
			textDoActionListener);
			
	com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.TEXT_ACTION_ENTER,
			textDoActionListener);		
	
	com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.PARAGRAPH_ACTION_DELETE,
			textDoActionListener);		
	
	com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.PARAGRAPH_ACTION_BACKSPACE,
			textDoActionListener);		
	
	com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.TEXT_ACTION_COLLAPSED_BACKSPACE_DELETE,
			textDoActionListener);
	
	com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.TEXT_ACTION_INPUT,
			textDoActionListener);
	
	com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.TEXT_ACTION_REPLACE,
			textDoActionListener);
