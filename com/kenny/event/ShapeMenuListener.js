...
* @author Haipei ZHANG
*/
if (!com.kenny.event.ShapeMenuListener) {
    com.kenny.event.ShapeMenuListener = function () {	
        this.update = function (message) {
            switch (message.id) { 
                case com.kenny.util.Observer.MessageType.SHAPE_FOCUS:
                    currentSelectedObj = message.sender;
                    break;
                case com.kenny.util.Observer.MessageType.SVG_STYLE_NOTIFY:
                	...
                	break;
                case com.kenny.util.Observer.MessageType.SVG_TEXT_STYLE_NOTIFY:
                	currentSelectedObj = message.sender;
            ...
            if (message.id == com.kenny.util.Observer.MessageType.SHAPE_FOCUS || message.id == com.kenny.util.Observer.MessageType.SVG_TEXT_STYLE_NOTIFY) {
            	//When it is for text
                var menuEditButton = $('.menu-toolbar-text');
                var showEditButtonFlag = false;
            	if(message.id == com.kenny.util.Observer.MessageType.SVG_TEXT_STYLE_NOTIFY){
    ...
    var shapeMenuListener = new com.kenny.event.ShapeMenuListener();
    com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SHAPE_FOCUS, shapeMenuListener);
    com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_STYLE_NOTIFY, shapeMenuListener);
    com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_STYLE_NOTIFY, shapeMenuListener);
    com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.POPU_MENU, shapeMenuListener);
}
