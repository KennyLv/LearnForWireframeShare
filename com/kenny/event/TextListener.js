 ...
 * @author Jian.T
 */
if (!com.kenny.event.TextListener) {
	com.kenny.event.TextListener = function() {
		this.update = function(message) {
			switch(message.id){
				case com.kenny.util.Observer.MessageType.TEXT_STYLE:
					...
					if(!selection.isCollapsed()){
						...
						var styleHistoryLst = com.kenny.util.BaseTool.cloneJsObject(pageObj.getTextStyles(from, to, fromOffset, toOffset));
	...
	com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.TEXT_STYLE,
			new com.kenny.event.TextListener());
}
