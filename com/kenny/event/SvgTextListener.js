 ...
 * @author lu_feng
 */
if (!com.kenny.event.SvgTextListener) {
	com.kenny.event.SvgTextListener = function() {
		this.update = function(message) {
			this._activeItem = message.sender;
			var validFlag = true;
			
			switch(message.id){
				case com.kenny.util.Observer.MessageType.SVG_TEXT_INPUT:
					this.doInputAction(message.data.valDataArr, message.data.imeModeFlag);
					break;
					
				case com.kenny.util.Observer.MessageType.SVG_TEXT_INPUT_ITEM:
					this.doInputItemAction(message.data.val, message.data.imeModeFlag);
					break;
					
				case com.kenny.util.Observer.MessageType.SVG_TEXT_DELETE:
				...
				case com.kenny.util.Observer.MessageType.SVG_TEXT_BACKSPACE:
					this.doBackspaceAction();
					com.kenny.util.BaseTool.hiddenSvgOverWordDiv();
					break;
					
				case com.kenny.util.Observer.MessageType.SVG_TEXT_ENTER:
					this.doEnterAction();
					break;
					
				case com.kenny.util.Observer.MessageType.SVG_TEXT_LEFT:
					this.doLeftAction();
					break;
					
				case com.kenny.util.Observer.MessageType.SVG_TEXT_RIGHT:
					this.doRightAction();
					break;
					
				case com.kenny.util.Observer.MessageType.SVG_TEXT_UP:
					this.doUpAction();
					break;
					
				case com.kenny.util.Observer.MessageType.SVG_TEXT_DOWN:
					this.doDownAction();
					break;
					
				case com.kenny.util.Observer.MessageType.SVG_TEXT_STYLE:
			...
			if(validFlag && message.id != com.kenny.util.Observer.MessageType.SVG_TEXT_INPUT){
	...
	com.kenny.event.SvgTextListener.prototype = {
		_activeItem: null,
		
		_updateCursor: function(selection, type){
			type = type == null ? com.kenny.util.Observer.MessageType.SVG_CURSOR_SHOW : type;
		...
		_setKeyBoardActive: function(){
			var message = new com.kenny.util.Observer.Message();
			message.id = com.kenny.util.Observer.MessageType.SVG_KEYBOARD_ACTIVE;
			com.kenny.util.Observer.sendMessage(message);
		},
		...
		doDeleteAction: function(data){
			...
			var selection = new com.kenny.model.SvgTextSelectionModel();
			...
			var undo = function(data){
				...
				if(data.selection.isCollapsed()){
					...
					self._updateCursor(data.selection, com.kenny.util.Observer.MessageType.SVG_CURSOR_HIDE);
					com.kenny.util.BaseTool.markSvgTextSelection(data.selection);
				}
				self._setKeyBoardActive();
				self.sendTextStyleEvent(selection);
			};
		...
		doStyleAction: function(styleDataPara){
			...
			var redo = function(){
				...
				if(selection.isCollapsed()){
					...
					com.kenny.util.BaseTool.markSvgTextSelection(selection);
				}
	...
	(function(){
		var listener = new com.kenny.event.SvgTextListener();
		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_DELETE, listener);
		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_BACKSPACE, listener);
		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_ENTER, listener);
		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_LEFT, listener);
		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_RIGHT, listener);
		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_UP, listener);
		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_DOWN, listener);
		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_INPUT, listener);
		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_INPUT_ITEM, listener);
		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_STYLE, listener);
	})();
}
