...
* @author Haipei ZHANG
*/
if (!com.kenny.event.TextMenuListener) {
    com.kenny.event.TextMenuListener = function () {	
    ...
    var textMenuListener = new com.kenny.event.TextMenuListener();
    com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.TEXT_SELECT, textMenuListener);
    com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.DOCUMENT_CONFIGURATION, textMenuListener);
    com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.POPU_MENU, textMenuListener);
}
