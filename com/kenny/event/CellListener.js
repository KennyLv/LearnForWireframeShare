 ...
 * @author xuliyu
 */
if (!com.kenny.event.CellListener) {
    com.kenny.event.CellListener = function () {
    ...
    com.kenny.event.CellStyleListener = function () {
...
//	            }
   //         }
        ...
        this.update = function (message) {
            switch (message.id) {
                ...
                default:
                    if (activeTable != null) {
                        switch (message.id) {
                            case com.kenny.util.Observer.MessageType.CELL_STYLE:
                                var styleData = message.data;
                                break;
                            case com.kenny.util.Observer.MessageType.CELL_CHANGED:
    ...
    com.kenny.event.CellFunctionListener = function () {
        var setFunctionModel = false;
        this.update = function (message) {
            switch (message.id) {
                case com.kenny.util.Observer.MessageType.CELL_ADDFUNCTION:
    ...
    com.kenny.event.CellEditListener = function () {
        ...
        this.update = function (message) {
        	...
        	switch (message.id) {
        		case com.kenny.util.Observer.MessageType.CELL_CUT:
//        			tempCellArray = [];
//        			rowColNum = [];
...
//        			var oldCellArray = getSelectionCell(activeTableObj,activeSelection);
        			...
        			break;
        		case com.kenny.util.Observer.MessageType.CELL_COPY:
        			tempCellArray = [];
        			rowColNum = [];
        			rowColNum.push(activeSelection.getRowNumber());
        			rowColNum.push(activeSelection.getColNumber());
        			copyCellValue(activeSelection,activeTableObj,tempCellArray);
        			break;
				case com.kenny.util.Observer.MessageType.CELL_DELETE:
//					var oldCellArray = getSelectionCell(activeTableObj,activeSelection);
					var currentActiveTable = activeTableObj;
        			var currentActiveSelection = activeSelection;
					jsk.execute(
...
//    						pasteCells(currentSecition,currentTable,oldCellArray,false,true);
				    ...
				    break;
				case com.kenny.util.Observer.MessageType.CELL_PASTE:
...
//					var oldCellArray = getSelectionCell(activeTableObj,activeSelection);
					...
					break;
				case com.kenny.util.Observer.MessageType.CELL_FORMULAS:
...
//                	var oldCellArray = getSelectionCell(activeTableObj,activeSelection);
					...
					break;
				case com.kenny.util.Observer.MessageType.CELL_VALUES:
//					activeSelection.setRowNumber(rowColNum[0]);
//                	activeSelection.setColNumber(rowColNum[1]);
//                	var oldCellArray = getSelectionCell(activeTableObj,activeSelection);
					var currentActiveTable = activeTableObj;
...
//    						pasteCellValue(currentSecition,currentTable,oldCellArray,false);
	...
	var cellStyleListener = new com.kenny.event.CellStyleListener();
	//com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.CONTEXT_BLUR, cellStyleListener);
	com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.TABLE_FOCUS, cellStyleListener);
	com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.CELL_STYLE, cellStyleListener);
	com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.CELL_CHANGED, cellStyleListener);
	//sunwei
	var cellEditListener = new com.kenny.event.CellEditListener();
	com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.CELL_CUT, cellEditListener);
	com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.CELL_COPY, cellEditListener);
	com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.CELL_DELETE, cellEditListener);
	com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.CELL_PASTE, cellEditListener);
	com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.CELL_FORMULAS, cellEditListener);
	com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.CELL_VALUES, cellEditListener);

    com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.CELL_CLICK,
			new com.kenny.event.CellListener());
    com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.CELL_DBLCLICK,
			new com.kenny.event.CellListener());



    var cellFunctionListener = new com.kenny.event.CellFunctionListener();
    com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.CELL_ADDFUNCTION, cellFunctionListener
			);
    com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.CELL_CLICK, cellFunctionListener
			);
    com.kenny.util.Observer.register(
			com.kenny.util.Observer.MessageType.CONTEXT_BLUR, cellFunctionListener
			);    
}