...
com.kenny.util.SvgSelection = {
	...
	registerListener: function(divContainer, mousedown, mouseup, mousemove){
		...
		this._divContainer.onmousedown = function(e){
			...
			var obj = com.kenny.util.BaseTool.findEventTarget(e);
			...
			self._divContainer.onmousemove = function(e){
				...
				var selection = com.kenny.model.SvgTextSelectionModelHelper.parseWindowSelection(self.svgSelection, e);
	...
	getSVGSelection: function(type, e){
		...
		var coordinates = com.kenny.util.BaseTool.getRelativeCoordinates(e, textBoxDomInstance);
