 ...
 * @author lu_feng
 */
com.kenny.util.AlgorithmsParseTools = {
    debug: true,
...
//alert(com.kenny.util.AlgorithmsParseTools.doCal("COUNT(0,100,(SUM(3,2)+3)+SUM(2,SUM(3,2))/4-AVERAGE(SUM(3,2),SUM(3,2))*(SUM(3,2)-SUM(3,4))+4,200,30)"));//
//alert(com.kenny.util.AlgorithmsParseTools.doCal("MAX(0,100,(SUM(3,2)+3)+SUM(2,SUM(3,2))/4-AVERAGE(SUM(3,2),SUM(3,2))*(SUM(3,2)-SUM(3,4))+4,200,30)"));//