...
Log.popupLogger = function(msg,level,obj) {
       ...
       if (!obj._window || !obj._window.document) {
               obj._window = window.open("",'logger_popup_window','width=520,height=320,scrollbars=1,status=0,toolbars=0,resizable=1');
	       ...
	       if (!obj._window.document.getElementById('loggerTable')) {
                       obj._window.document.writeln("<table width='100%' id='loggerTable'><tr><th align='left'>Time</th><th width='100%' colspan='2' align='left'>Message</th></tr></table><div id='clearBtn' width='100%'>clear</div>");
       ...
       var clearBtn = obj._window.document.getElementById('clearBtn');
       clearBtn.style.marginTop = "10px";
       clearBtn.style.textAlign = "right";
       clearBtn.style.fontSize = "10pt";
       clearBtn.style.fontFamily = "Verdana";
       clearBtn.style.textDecoration = "underline";
       clearBtn.style.cursor = "pointer";
       clearBtn.addEventListener('click', function(){
	    	   tbl.innerHTML = "<tr><th align='left'>Time</th><th width='100%' colspan='2' align='left'>Message</th></tr>";
	       }, true);
