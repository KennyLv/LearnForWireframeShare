 ...
 * @author Feng.Lu
 */
com.kenny.helper.ChartHelper = {
    _cache : new com.kenny.util.Hashtable(),
    ...
    drawlegend : function(c) {
        var r = this.getPaper(c.getId(), c.getDomInstance()), 
            pieData = com.kenny.util.CommonUtil.cloneJsObject(c.getPieData());
        ...
        for (var i = 0; i < pieData.length; i++) {
            ...
            labels.push(cache.split(" ")[i]); //com.kenny.util.CommonUtil.getRandomNum(8)
        }
