 ...
 * @author lu_feng
 */
com.kenny.model.LineModel = function(paragraph, indentStyle, rowIndex) {
	this._type = "Line";
	this._groupId = this._id = com.kenny.util.BaseTool.uuid();
...
com.kenny.model.LineModel.prototype = {
	_domInstance: null,
	_type: null,
	_id: null,
	_data: null,
	...
	_createDomInstance: function(){
		...
		if(this._rowIndex == 0){
			com.kenny.util.BaseTool.setStyleProperty(this._domInstance.style, 'padding-left', this._indentStyle.firstLine+"px");
		}
		else{
			com.kenny.util.BaseTool.setStyleProperty(this._domInstance.style, 'padding-left', this._indentStyle.left+"px");
		}
		
		com.kenny.util.BaseTool.setStyleProperty(this._domInstance.style, 'padding-right', this._indentStyle.right+"px");
		...
		/*******
		//com.kenny.util.BaseTool.setStyleProperty(lineObj.style, 'height', height+'px');
		
		//Based on paragraph settings
		com.kenny.util.BaseTool.setStyleProperty(this._domInstance.style, 'text-align', 'left');
		com.kenny.util.BaseTool.setStyleProperty(this._domInstance.style, 'direction', 'ltr');
		
		this._lineContentInstance = document.createElement("div");
		this._lineContentInstance.className = "hr-line-view-content";
		com.kenny.util.BaseTool.setStyleProperty(this._lineContentInstance.style, 'padding-top', '0pt');
		...
		com.kenny.util.BaseTool.setStyleProperty(this._lineSpanInstance.style, 'padding-left', '0px');
		com.kenny.util.BaseTool.setStyleProperty(this._lineSpanInstance.style, 'width', '800px');
	...
	_updateDom: function(){
		...
		com.kenny.util.BaseTool.setStyleProperty(this._domInstance.style, 'height', this.getHeight()+"px");
		if(this.getPaddingTop()) com.kenny.util.BaseTool.setStyleProperty(this._domInstance.style, 'padding-top', this.getPaddingTop()+"px");
		...
		for(var j=0;j<items.length;j++){
			...
			if(lineItemObj.paddingLeft && lineItemObj.paddingLeft!=0){
				com.kenny.util.BaseTool.setStyleProperty(spanObj.style, 'padding-left', lineItemObj.paddingLeft+"px");
			}
...
//                message.id = com.kenny.util.Observer.MessageType.KEYBOARD_ADD;
//                message.sender = spanObj;
