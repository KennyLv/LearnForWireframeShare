...
com.kenny.model.SvgStyle.prototype = {
	...
	setBackground:function(_background) {
		this._background = com.kenny.util.BaseTool.rgb2hex(_background);
	},
...
//    msg.id = com.kenny.util.Observer.MessageType.SVG_TEXT_STYLE;
//    msg.sender = __svgActiveItem;
//    msg.data = style;
//    com.kenny.util.Observer.sendMessage(msg);
//}
//
//if (!com.kenny.model.SvgTextStyleMenuListener) {
//	com.kenny.model.SvgTextStyleMenuListener = function() {
...
//	};
//	(function(){
//		var listener = new com.kenny.model.SvgTextStyleMenuListener();
//		com.kenny.util.Observer.register(com.kenny.util.Observer.MessageType.SVG_TEXT_STYLE_NOTIFY, listener);
//	})();
//};
