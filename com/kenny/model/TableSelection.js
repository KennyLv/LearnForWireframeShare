 ...
 * @author lu_feng
 */
com.kenny.model.TableSelection = function(row, col, rowNumber, colNumber) {
...
com.kenny.model.TableSelection.prototype = {
	_id : null,
	_row : null,
	_col : null,
	_rowNumber : null,
	...
	clone : function() {
		var cloneObj = new com.kenny.model.TableSelection();
		cloneObj.setData(this.getData());
		return cloneObj;
	},

	copy : function() {
		var copyObj = new com.kenny.model.TableSelection();
